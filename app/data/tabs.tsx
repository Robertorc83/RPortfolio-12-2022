...
const tabs: Tab[] = [
    {
        label: "Info",
        component: <div className="flex items-center flex-col py-10 md:py-0 px-8 md:px-20 font-abril text-center text-sm lg:text-base">
    ...
    {
        label: "Interests",
        component: <div className="flex items-center justify-center h-full flex-col py-10 md:py-0 px-8 md:px-20 font-abril text-center text-sm lg:text-base">
