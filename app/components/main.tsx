...
export default function Main(){
    ...
    return(
        <div>
          <div className="grid lg:grid-cols-12 mt-16">
            <div className="col-span-8">
              <motion.h2 
                ...
                className="w-5/6 ml-16 lg:ml-24 lg:w-auto animate-text bg-gradient-to-r from-amber-200 via-red-400 to-orange-400 bg-clip-text text-transparent text-[60px] font-bold font-bal h-[400px] lg:h-[350px] leading-snug ">
                  I love creating awesome digital experiences and innovative products
              </motion.h2>
              <div className="h-32 w-full lg:w-32 mt-20 lg:mt-0 lg:ml-20 flex text-center lg:text-start justify-center lg:justify-start" >
                <motion.p
          ...
          <motion.div 
            ...
            className="hidden lg:block absolute top-64 right-10 lg:top-96 lg:right-10"
          >
