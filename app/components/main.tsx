          ...
          <div className="grid lg:grid-cols-12 mt-16 h-full">
            <div className="col-span-8">
              ...
              <div className="h-32 w-full lg:w-32 mt-20 lg:mt-0 lg:ml-20 xl:mt-36 flex text-center lg:text-start justify-center lg:justify-start" >
                ...
                >
                  <a href="https://www.linkedin.com/in/robertoes/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faLinkedinIn} className="text-white font-monoton h-8 px-5 xl:h-16 cursor-pointer"/></a>
                </motion.p>
                <motion.p
                  whileHover={{ scale: 1.2 }}
                  whileTap={{ scale: 0.9 }}
                  ...
                  transition={{ ease: "easeOut", duration: 1.8 }}
                >
                  <a href="https://github.com/Robertorc83?tab=repositories" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faGithub} className="text-white font-monoton h-8 px-5 xl:h-16 cursor-pointer"/></a>
                </motion.p>
                <motion.p
                  whileHover={{ scale: 1.2 }}
                  whileTap={{ scale: 0.9 }}
                  ...
                  transition={{ ease: "easeOut", duration: 1.8 }}
                >
                  <a href="https://drive.google.com/file/d/1ZCapCkvxm2O6o-SkKlmiY9sMEkrKEYTy/view?usp=sharing" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faFileLines} className="text-white font-monoton h-8 px-5 xl:h-16 cursor-pointer"/></a>
                </motion.p>
              </div>
            </div> 
          </div>
