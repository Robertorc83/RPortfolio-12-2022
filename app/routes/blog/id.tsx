            ...
            <div className="pb-20 mt-16 ">
                ...
                <div className="grid grid-cols-5">
                    <div className="col-span-4 mt-10 px-36">
                        <p className="text-white mt-10 font-abril">
                        ...
                        <h3 className=" animate-text bg-gradient-to-r from-amber-200 via-red-400 to-orange-400 bg-clip-text text-transparent text-2xl font-monoton tracking-widest">Reconciliation in react fiber</h3>
                        <p className="text-white font-abril mt-10 ">
